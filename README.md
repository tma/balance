...
- **AI-Powered Import** *(experimental)* - Import transactions from bank statements (CSV/XLS/XLSX) using local LLM
...
2. Pull the required models:
   ...
   ollama pull llama3.1:8b       # Required for statement format detection
   ```
